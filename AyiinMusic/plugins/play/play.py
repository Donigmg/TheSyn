...
from AyiinMusic.utils.decorators.play import PlayWrapper
from AyiinMusic.utils.formatters import formats
from AyiinMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
...
@app.on_callback_query(
    filters.regex("AyiinPlaylists") & ~BANNED_USERS
)
@languageCB
